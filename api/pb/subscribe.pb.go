...
var fileDescriptor_38d2980c9543da44 = []byte{
	...
	0x1c, 0xa3, 0x4f, 0x8c, 0x5c, 0x9c, 0x70, 0x53, 0x84, 0x8c, 0xb8, 0x58, 0x7c, 0x32, 0x8b, 0x4b,
	0x84, 0x44, 0xf4, 0x0a, 0x92, 0xf4, 0xd0, 0x1d, 0x21, 0x25, 0x84, 0x26, 0x5a, 0x90, 0x53, 0xa9,
	0xc4, 0x20, 0xa4, 0xcb, 0xc5, 0x11, 0x94, 0x9a, 0x9e, 0x59, 0x5c, 0x92, 0x5a, 0x84, 0x43, 0x1f,
	0x27, 0x58, 0x14, 0x64, 0x9d, 0x12, 0x83, 0x90, 0x26, 0x17, 0x8b, 0x7f, 0x41, 0x6a, 0x1e, 0x31,
	0x4a, 0xb5, 0xb8, 0x58, 0x9d, 0x73, 0xf2, 0x8b, 0x53, 0x89, 0x51, 0xab, 0xcd, 0xc5, 0x06, 0x62,
	0x96, 0x16, 0x13, 0xa1, 0xd8, 0x89, 0x23, 0x8a, 0x2d, 0xb1, 0x20, 0x53, 0xbf, 0x20, 0x29, 0x89,
	0x0d, 0x1c, 0xec, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x8b, 0xd6, 0xe5, 0x46, 0x89, 0x01,
	0x00, 0x00,
}
...
func (c *subscribeClient) Register(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*State, error) {
	out := new(State)
...
func (c *subscribeClient) Status(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*State, error) {
	out := new(State)
...
type SubscribeServer interface {
	...
	Register(context.Context, *SubscribeRequest) (*State, error)
	Open(context.Context, *SubscribeRequest) (*State, error)
	Close(context.Context, *SubscribeRequest) (*State, error)
	Status(context.Context, *SubscribeRequest) (*State, error)
}
...
func (*UnimplementedSubscribeServer) Register(ctx context.Context, req *SubscribeRequest) (*State, error) {
...
func (*UnimplementedSubscribeServer) Status(ctx context.Context, req *SubscribeRequest) (*State, error) {
