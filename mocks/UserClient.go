...
func (_m *UserClient) Authorization(ctx context.Context, in *pb.TextRequest, opts ...grpc.CallOption) (*pb.StateReply, error) {
...
func (_m *UserClient) GetRole(ctx context.Context, in *pb.RoleRequest, opts ...grpc.CallOption) (*pb.RoleReply, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *pb.RoleReply
	if rf, ok := ret.Get(0).(func(context.Context, *pb.RoleRequest, ...grpc.CallOption) *pb.RoleReply); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *pb.RoleRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
