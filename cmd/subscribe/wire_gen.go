...
func CreateApp() (*app.Application, error) {
	...
	application, err := subscribe.NewApp(appConfig, loggerLogger, server, clientv3Client)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(config.ProviderSet, logger.ProviderSet, http.ProviderSet, rpc.ProviderSet, jaeger.ProviderSet, etcd.ProviderSet, influx.ProviderSet, redis.ProviderSet, subscribe.ProviderSet, mysql.ProviderSet, rollbar.ProviderSet, consul.ProviderSet)
