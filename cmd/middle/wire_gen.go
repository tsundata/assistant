...
func CreateApp() (*app.Application, error) {
	...
	application, err := middle.NewApp(appConfig, loggerLogger, server, clientv3Client, redisClient, middleRepository)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(config.ProviderSet, logger.ProviderSet, http.ProviderSet, rpc.ProviderSet, jaeger.ProviderSet, etcd.ProviderSet, influx.ProviderSet, redis.ProviderSet, middle.ProviderSet, mysql.ProviderSet, rollbar.ProviderSet, repository.ProviderSet, consul.ProviderSet)
