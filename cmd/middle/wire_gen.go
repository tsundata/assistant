...
func CreateApp(id string) (*app.Application, error) {
	...
	middleRepository := repository.NewMysqlMiddleRepository(logger, db)
	...
	application, err := middle.NewApp(appConfig, logger, server)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(config.ProviderSet, log.ProviderSet, rpc.ProviderSet, jaeger.ProviderSet, influx.ProviderSet, redis.ProviderSet, middle.ProviderSet, mysql.ProviderSet, rollbar.ProviderSet, repository.ProviderSet, consul.ProviderSet, service.ProviderSet, rpcclient.ProviderSet)
