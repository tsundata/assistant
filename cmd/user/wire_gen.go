...
func CreateApp() (*app.Application, error) {
	...
	application, err := user.NewApp(appConfig, bus, loggerLogger, server, redisClient, userRepository)
	if err != nil {
		return nil, err
	}
...
var providerSet = wire.NewSet(config.ProviderSet, logger.ProviderSet, http.ProviderSet, rpc.ProviderSet, jaeger.ProviderSet, influx.ProviderSet, redis.ProviderSet, user.ProviderSet, mysql.ProviderSet, rollbar.ProviderSet, consul.ProviderSet, repository.ProviderSet, event.ProviderSet, nats.ProviderSet)
