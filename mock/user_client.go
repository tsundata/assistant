...
type MockUnsafeUserSvcServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeUserSvcServerMockRecorder
}
...
func NewMockUnsafeUserSvcServer(ctrl *gomock.Controller) *MockUnsafeUserSvcServer {
	mock := &MockUnsafeUserSvcServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeUserSvcServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeUserSvcServer) EXPECT() *MockUnsafeUserSvcServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedUserSvcServer mocks base method.
func (m *MockUnsafeUserSvcServer) mustEmbedUnimplementedUserSvcServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedUserSvcServer")
}

// mustEmbedUnimplementedUserSvcServer indicates an expected call of mustEmbedUnimplementedUserSvcServer.
func (mr *MockUnsafeUserSvcServerMockRecorder) mustEmbedUnimplementedUserSvcServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedUserSvcServer", reflect.TypeOf((*MockUnsafeUserSvcServer)(nil).mustEmbedUnimplementedUserSvcServer))
}
