...
// Source: ./api/pb/workflow_grpc.pb.go
...
func (m *MockWorkflowSvcClient) ListWebhook(ctx context.Context, in *pb.WorkflowRequest, opts ...grpc.CallOption) (*pb.WebhooksReply, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockWorkflowSvcClientMockRecorder) ListWebhook(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListWebhook", reflect.TypeOf((*MockWorkflowSvcClient)(nil).ListWebhook), varargs...)
}
...
func (mr *MockWorkflowSvcServerMockRecorder) ListWebhook(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListWebhook", reflect.TypeOf((*MockWorkflowSvcServer)(nil).ListWebhook), arg0, arg1)
}
...
type MockUnsafeWorkflowSvcServer struct {
	ctrl     *gomock.Controller
	recorder *MockUnsafeWorkflowSvcServerMockRecorder
}
...
type MockUnsafeWorkflowSvcServerMockRecorder struct {
	mock *MockUnsafeWorkflowSvcServer
}
...
func NewMockUnsafeWorkflowSvcServer(ctrl *gomock.Controller) *MockUnsafeWorkflowSvcServer {
	mock := &MockUnsafeWorkflowSvcServer{ctrl: ctrl}
	mock.recorder = &MockUnsafeWorkflowSvcServerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUnsafeWorkflowSvcServer) EXPECT() *MockUnsafeWorkflowSvcServerMockRecorder {
	return m.recorder
}

// mustEmbedUnimplementedWorkflowSvcServer mocks base method.
func (m *MockUnsafeWorkflowSvcServer) mustEmbedUnimplementedWorkflowSvcServer() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "mustEmbedUnimplementedWorkflowSvcServer")
}

// mustEmbedUnimplementedWorkflowSvcServer indicates an expected call of mustEmbedUnimplementedWorkflowSvcServer.
func (mr *MockUnsafeWorkflowSvcServerMockRecorder) mustEmbedUnimplementedWorkflowSvcServer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "mustEmbedUnimplementedWorkflowSvcServer", reflect.TypeOf((*MockUnsafeWorkflowSvcServer)(nil).mustEmbedUnimplementedWorkflowSvcServer))
}
