...
type UserSvcClient interface {
	Login(ctx context.Context, in *pb.LoginRequest) (*pb.AuthReply, error)
	GetAuthToken(ctx context.Context, in *pb.AuthRequest) (*pb.AuthReply, error)
	Authorization(ctx context.Context, in *pb.AuthRequest) (*pb.AuthReply, error)
	GetRole(ctx context.Context, in *pb.RoleRequest) (*pb.RoleReply, error)
	GetRoleImage(ctx context.Context, in *pb.RoleRequest) (*pb.BytesReply, error)
	CreateUser(ctx context.Context, in *pb.UserRequest) (*pb.UserReply, error)
	GetUser(ctx context.Context, in *pb.UserRequest) (*pb.UserReply, error)
	GetUserByName(ctx context.Context, in *pb.UserRequest) (*pb.UserReply, error)
	GetUsers(ctx context.Context, in *pb.UserRequest) (*pb.UsersReply, error)
	UpdateUser(ctx context.Context, in *pb.UserRequest) (*pb.StateReply, error)
	BindDevice(ctx context.Context, in *pb.DeviceRequest) (*pb.StateReply, error)
}
...
func NewUser(conf *config.AppConfig, logger log.Logger, rdb *redis.Client, repo repository.UserRepository) UserSvcClient {
