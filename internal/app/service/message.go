...
type MessageSvcClient interface {
	List(ctx context.Context, in *pb.MessageRequest) (*pb.MessagesReply, error)
	ListByGroup(ctx context.Context, in *pb.GetMessagesRequest) (*pb.GetMessagesReply, error)
	GetByIds(ctx context.Context, in *pb.GetMessagesRequest) (*pb.GetMessagesReply, error)
	LastByGroup(ctx context.Context, in *pb.LastByGroupRequest) (*pb.LastByGroupReply, error)
	GetById(ctx context.Context, in *pb.MessageRequest) (*pb.GetMessageReply, error)
	GetBySequence(ctx context.Context, in *pb.MessageRequest) (*pb.GetMessageReply, error)
	Create(ctx context.Context, in *pb.MessageRequest) (*pb.MessageReply, error)
	Save(ctx context.Context, in *pb.MessageRequest) (*pb.MessageReply, error)
	Delete(ctx context.Context, in *pb.MessageRequest) (*pb.TextReply, error)
	Send(ctx context.Context, in *pb.MessageRequest) (*pb.StateReply, error)
	Run(ctx context.Context, in *pb.MessageRequest) (*pb.TextReply, error)
	Action(ctx context.Context, in *pb.ActionRequest) (*pb.ActionReply, error)
	Form(ctx context.Context, in *pb.FormRequest) (*pb.FormReply, error)
	ListInbox(ctx context.Context, in *pb.InboxRequest) (*pb.InboxReply, error)
	LastInbox(ctx context.Context, in *pb.InboxRequest) (*pb.InboxReply, error)
	MarkSendInbox(ctx context.Context, in *pb.InboxRequest) (*pb.InboxReply, error)
	MarkReadInbox(ctx context.Context, in *pb.InboxRequest) (*pb.InboxReply, error)
}
...
func NewMessage(
	...
	repo repository.MessageRepository,
	storage pb.StorageSvcClient,
	middle MiddleSvcClient) MessageSvcClient {
	return &Message{
		bus:     bus,
		logger:  logger,
		redis:   redis,
