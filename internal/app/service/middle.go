...
import (
	...
	"github.com/tsundata/assistant/internal/app/classifier"
...
type MiddleSvcClient interface {
	CreatePage(ctx context.Context, in *pb.PageRequest) (*pb.TextReply, error)
	GetPage(ctx context.Context, in *pb.PageRequest) (*pb.PageReply, error)
	GetQrUrl(ctx context.Context, in *pb.TextRequest) (*pb.TextReply, error)
	GetApps(ctx context.Context, in *pb.TextRequest) (*pb.AppsReply, error)
	GetAvailableApp(ctx context.Context, in *pb.TextRequest) (*pb.AppReply, error)
	StoreAppOAuth(ctx context.Context, in *pb.AppRequest) (*pb.StateReply, error)
	GetCredentials(ctx context.Context, in *pb.TextRequest) (*pb.CredentialsReply, error)
	GetMaskingCredentials(ctx context.Context, in *pb.TextRequest) (*pb.MaskingReply, error)
	GetCredential(ctx context.Context, in *pb.CredentialRequest) (*pb.CredentialReply, error)
	CreateCredential(ctx context.Context, in *pb.KVsRequest) (*pb.StateReply, error)
	GetSettings(ctx context.Context, in *pb.TextRequest) (*pb.SettingsReply, error)
	GetSetting(ctx context.Context, in *pb.TextRequest) (*pb.SettingReply, error)
	CreateSetting(ctx context.Context, in *pb.KVRequest) (*pb.StateReply, error)
	GetStats(ctx context.Context, in *pb.TextRequest) (*pb.TextReply, error)
	ListSubscribe(ctx context.Context, in *pb.SubscribeRequest) (*pb.SubscribeReply, error)
	RegisterSubscribe(ctx context.Context, in *pb.SubscribeRequest) (*pb.StateReply, error)
	OpenSubscribe(ctx context.Context, in *pb.SubscribeRequest) (*pb.StateReply, error)
	CloseSubscribe(ctx context.Context, in *pb.SubscribeRequest) (*pb.StateReply, error)
	GetSubscribeStatus(ctx context.Context, in *pb.SubscribeRequest) (*pb.StateReply, error)
	GetUserSubscribe(ctx context.Context, in *pb.TextRequest) (*pb.GetUserSubscribeReply, error)
	SwitchUserSubscribe(ctx context.Context, in *pb.SwitchUserSubscribeRequest) (*pb.StateReply, error)
	GetUserSubscribeStatus(ctx context.Context, in *pb.TextRequest) (*pb.StateReply, error)
	ListCron(ctx context.Context, in *pb.CronRequest) (*pb.CronReply, error)
	RegisterCron(ctx context.Context, in *pb.CronRequest) (*pb.StateReply, error)
	StartCron(ctx context.Context, in *pb.CronRequest) (*pb.StateReply, error)
	StopCron(ctx context.Context, in *pb.CronRequest) (*pb.StateReply, error)
	GetCronStatus(ctx context.Context, in *pb.CronRequest) (*pb.StateReply, error)
	GetOrCreateTag(ctx context.Context, in *pb.TagRequest) (*pb.TagReply, error)
	GetTags(ctx context.Context, in *pb.TagRequest) (*pb.TagsReply, error)
	SaveModelTag(ctx context.Context, in *pb.ModelTagRequest) (*pb.ModelTagReply, error)
	GetTagsByModelId(ctx context.Context, in *pb.ModelIdRequest) (*pb.GetTagsReply, error)
	GetModelTags(ctx context.Context, in *pb.ModelTagRequest) (*pb.GetTagsReply, error)
	GetChartData(ctx context.Context, in *pb.ChartDataRequest) (*pb.ChartDataReply, error)
	SetChartData(ctx context.Context, in *pb.ChartDataRequest) (*pb.ChartDataReply, error)
	GetChartUrl(ctx context.Context, in *pb.TextRequest) (*pb.TextReply, error)
	Pinyin(ctx context.Context, in *pb.TextRequest) (*pb.WordsReply, error)
	Segmentation(ctx context.Context, in *pb.TextRequest) (*pb.WordsReply, error)
	Classifier(ctx context.Context, in *pb.TextRequest) (*pb.TextReply, error)
	CreateAvatar(ctx context.Context, in *pb.TextRequest) (*pb.TextReply, error)
	CreateCounter(ctx context.Context, in *pb.CounterRequest) (*pb.StateReply, error)
	GetCounter(ctx context.Context, in *pb.CounterRequest) (*pb.CounterReply, error)
	GetCounters(ctx context.Context, in *pb.CounterRequest) (*pb.CountersReply, error)
	ChangeCounter(ctx context.Context, in *pb.CounterRequest) (*pb.CounterReply, error)
	ResetCounter(ctx context.Context, in *pb.CounterRequest) (*pb.CounterReply, error)
	GetCounterByFlag(ctx context.Context, in *pb.CounterRequest) (*pb.CounterReply, error)
	Search(ctx context.Context, in *pb.TextRequest) (*pb.MetadataReply, error)
	CollectMetadata(ctx context.Context, in *pb.TextRequest) (*pb.StateReply, error)
}
...
func NewMiddle(conf *config.AppConfig, rdb *redis.Client, locker *global.Locker, repo repository.MiddleRepository, storage pb.StorageSvcClient) MiddleSvcClient {
