...
type ChatbotSvcClient interface {
	Handle(ctx context.Context, in *pb.ChatbotRequest) (*pb.ChatbotReply, error)
	Register(ctx context.Context, in *pb.BotRequest) (*pb.StateReply, error)
	Action(ctx context.Context, in *pb.BotRequest) (*pb.StateReply, error)
	Form(ctx context.Context, in *pb.BotRequest) (*pb.StateReply, error)
	GetBot(ctx context.Context, in *pb.BotRequest) (*pb.BotReply, error)
	GetBots(ctx context.Context, in *pb.BotsRequest) (*pb.BotsReply, error)
	CreateGroupBot(ctx context.Context, in *pb.GroupBotRequest) (*pb.StateReply, error)
	DeleteGroupBot(ctx context.Context, in *pb.GroupBotRequest) (*pb.StateReply, error)
	UpdateGroupBotSetting(ctx context.Context, in *pb.BotSettingRequest) (*pb.StateReply, error)
	UpdateGroupSetting(ctx context.Context, in *pb.GroupSettingRequest) (*pb.StateReply, error)
	GetGroupBotSetting(ctx context.Context, in *pb.BotSettingRequest) (*pb.BotSettingReply, error)
	GetGroupSetting(ctx context.Context, in *pb.GroupSettingRequest) (*pb.GroupSettingReply, error)
	GetGroups(ctx context.Context, in *pb.GroupRequest) (*pb.GetGroupsReply, error)
	CreateGroup(ctx context.Context, in *pb.GroupRequest) (*pb.StateReply, error)
	GetGroup(ctx context.Context, in *pb.GroupRequest) (*pb.GetGroupReply, error)
	DefaultGroupId(ctx context.Context, in *pb.IdRequest) (*pb.IdReply, error)
	DeleteGroup(ctx context.Context, in *pb.GroupRequest) (*pb.StateReply, error)
	UpdateGroup(ctx context.Context, in *pb.GroupRequest) (*pb.StateReply, error)
	SyntaxCheck(ctx context.Context, in *pb.WorkflowRequest) (*pb.StateReply, error)
	RunActionScript(ctx context.Context, in *pb.WorkflowRequest) (*pb.WorkflowReply, error)
	WebhookTrigger(ctx context.Context, in *pb.TriggerRequest) (*pb.WorkflowReply, error)
	CronTrigger(ctx context.Context, in *pb.TriggerRequest) (*pb.WorkflowReply, error)
	WatchTrigger(ctx context.Context, in *pb.TriggerRequest) (*pb.WorkflowReply, error)
	CreateTrigger(ctx context.Context, in *pb.TriggerRequest) (*pb.StateReply, error)
	DeleteTrigger(ctx context.Context, in *pb.TriggerRequest) (*pb.StateReply, error)
	GetWebhookTriggers(ctx context.Context, in *pb.TriggerRequest) (*pb.TriggersReply, error)
	GetCronTriggers(ctx context.Context, in *pb.TriggerRequest) (*pb.TriggersReply, error)
	GetWatchTriggers(ctx context.Context, in *pb.TriggerRequest) (*pb.TriggersReply, error)
	SwitchTriggers(ctx context.Context, in *pb.SwitchTriggersRequest) (*pb.StateReply, error)
	ActionDoc(ctx context.Context, in *pb.WorkflowRequest) (*pb.WorkflowReply, error)
	ListWebhook(ctx context.Context, in *pb.WorkflowRequest) (*pb.WebhooksReply, error)
}
...
type Chatbot struct {
	...
	message MessageSvcClient
	middle  MiddleSvcClient
...
func NewChatbot(
	...
	middle MiddleSvcClient,
	bot *rulebot.RuleBot,
	comp component.Component) ChatbotSvcClient {
	return &Chatbot{
		logger:  logger,
		bus:     bus,
		rdb:     rdb,
