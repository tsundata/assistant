...
func TestDocRule(t *testing.T) {
	...
	r := rules[11]
	comp := rulebot.NewComponent(nil, nil, nil, nil, nil, workflow, nil, nil, nil, nil)
	res := r.Parse(context.Background(), comp, tokens)
	require.Len(t, res, 1)
}
...
func TestTodoRule(t *testing.T) {
	...
	r := rules[14]
	comp := rulebot.NewComponent(nil, nil, nil, nil, nil, nil, nil, todo, nil, nil)
	res := r.Parse(context.Background(), comp, tokens)
...
func TestPinyinRule(t *testing.T) {
	...
	r := rules[16]
	comp := rulebot.NewComponent(nil, nil, nil, nil, nil, nil, nil, nil, nil, nlp)
	res := r.Parse(context.Background(), comp, tokens)
