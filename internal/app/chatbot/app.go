...
func NewApp(c *config.AppConfig, bus event.Bus, logger log.Logger, rs *rpc.Server, middle pb.MiddleClient, todo pb.TodoSvcClient, user pb.UserClient) (*app.Application, error) {
	// event bus register
