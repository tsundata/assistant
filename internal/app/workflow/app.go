...
func NewApp(name string, logger *logger.Logger, rs *rpc.Server, etcd *clientv3.Client, midClient pb.MiddleClient, msgClient pb.MessageClient) (*app.Application, error) {
	// service
