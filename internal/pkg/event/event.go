...
const (
	...
	SystemCounterCreateSubject   Subject = "system_counter_create"
	SystemCounterIncreaseSubject Subject = "system_counter_increase"
	SystemCounterDecreaseSubject Subject = "system_counter_decrease"
)
